        ...
        <article aria-labelledby="article-title">
          ...
          <header className="pt-16 pb-16 bg-parchment-gradient">
            <div className="container-narrow">
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <span className="text-caption">— Guide égyptologue francophone</span>
              </div>
            </div>
          </header>
          ...
          <footer className="section-y bg-luxury-gradient">
            <div className="container-narrow text-center">
              <h2 className="text-display-md text-white">Vous souhaitez visiter l&apos;Égypte ?</h2>
              <p className="text-gold-muted mt-4">
                Hisham organise votre voyage sur mesure — transferts, hébergements, excursions et
                guide inclus.
              </p>
